...
namespace K01Y25_Nhom4_BT02.Controllers
{
    ...
    public class CoursesController : ControllerBase
    {
        ...
        public IActionResult UpdateCourse(int id, [FromBody] Course_UpdateReq req)
        {
            ...
            return Ok(ApiResponse<Course_Res>.Success(updatedCourse, "Cập nhật khóa học thành công."));
        }
        ...
        public async Task<IActionResult> DeleteCourse(int id)
        {
            ...
            if (!isDeleted)
            {
                var isEnrollment = await _courseService.GetEnrollmentByCourseIdAsync(id);
